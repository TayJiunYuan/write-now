...
const Dashboard = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h2 className="p-4 text-3xl font-bold text-secondary">
        Welcome back, John.
      </h2>

      <div className="grid lg:grid-rows-2 lg:grid-cols-3 h-full gap-4 p-4">
        {/* top left */}
        <div className="relative lg:col-span-2 lg:row-start-1 bg-white rounded-lg h-[40vh]">
        ...
        {/* bottom left */}
        <div className="relative lg:col-span-2 lg:row-start-2 bg-white rounded-lg h-[40vh]">
